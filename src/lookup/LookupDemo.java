...
public class LookupDemo {
    ...
    public static void main(String[] args) {
        ...
        // When do you cast?
        Child c = (Child) parentChild; // need to cast when moving down the inheritance hierarchy
        Parent p = childChild; // no need to cast when moving up the inheritance hierarchy
    }
}
